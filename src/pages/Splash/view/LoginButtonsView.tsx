...
export default function LoginButtonsView(props: LoginButtonType) {
	const url = process.env.REACT_APP_KAKAO_AUTH_URL;

	return (
		<S.LoginButtonCont>
			<S.LoginButton to={url ? url : ''} bgColor={(props: any) => props.theme.color.kakao}>
			...
			<S.LoginButton to={url ? url : ''} bgColor={(props: any) => props.theme.color.naver}>
